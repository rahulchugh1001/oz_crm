...
<body class="bg-gradient-to-br from-slate-50 to-slate-100 h-screen overflow-hidden flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
        <div class="bg-white rounded-2xl shadow-2xl p-6 md:p-8 text-center">
            <!-- Animated Icon -->
            <div class="mb-4 flex justify-center">
                <div class="relative">
                    <div class="w-24 h-24 gradient-info rounded-full flex items-center justify-center animate-bounce-soft">
                        <i data-lucide="ban" class="w-12 h-12 text-white"></i>
                    </div>
                    <div class="absolute -top-1 -right-1 w-9 h-9 bg-amber-500 rounded-full flex items-center justify-center">
            ...
            <!-- Error Code -->
            <div class="mb-2">
                <h1 class="text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-sky-600">
                    405
                </h1>
            </div>
            ...
            <p class="text-slate-600 text-base mb-5">
                The request method used for this URL is not allowed. Please use a valid method and try again.
            </p>

            <!-- Request Info -->
            <div class="bg-cyan-50 border border-cyan-200 rounded-lg p-3 mb-5">
                <div class="flex items-start gap-3">
                    <div class="flex-shrink-0">
                        <i data-lucide="info" class="w-5 h-5 text-cyan-600"></i>
                    </div>
                    <div class="text-left">
                        <h3 class="font-semibold text-cyan-900 mb-1 text-sm">Request Details</h3>
                        <ul class="text-sm text-cyan-800 space-y-0.5">
