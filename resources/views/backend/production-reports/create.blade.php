...
@section('breadcrumb')
    <a href="{{ route('admin.production-reports.index') }}" class="text-slate-600 hover:text-slate-900">Production
        Reports</a>
...
@section('content')
    <div class="p-3">
        <div class="bg-white rounded-2xl border border-slate-200 shadow-subtle">
            <div class="px-4 py-3 border-b border-slate-200">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-slate-900">Roll Forming (SF1) Process - Production Report - Bulk
                            Entry</h2>
                        <p class="text-sm text-slate-500">Enter Roll Forming (SF1) production data for multiple machines at
                            once</p>
                    </div>
                </div>
            </div>

            <form id="productionReportCreateForm" action="{{ route('admin.production-reports.store') }}" method="POST"
                class="p-4">
                @csrf
                ...
                <div class="mb-4 pb-4 border-b border-slate-200">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        <div>
                            ...
                            <input type="number" id="global_workman_count" name="workman_count" min="0" step="1" value="0"
                        ...
                        <div>
                            ...
                            <input type="number" id="global_staff_count" name="staff_count" min="0" step="1" value="0"
                ...
                <div class="mb-4">
                    <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        <p class="text-xs text-blue-800">
                            <strong>How to use:</strong> Check the checkbox next to each machine to enable data entry. The
                            selected machines will be included when you save the form. All fields must be filled for
                            selected rows.
                        </p>
                    </div>
                    <div class="mb-2 flex items-center justify-end gap-2">
                        ...
                        <div class="flex items-center gap-2 mr-3 pr-3 border-r border-slate-200">
                            <span class="text-[10px] font-semibold text-slate-600 uppercase tracking-wider">All
                                Ballcage</span>
                            <label class="inline-flex items-center cursor-pointer">
                                <div class="relative">
                                    <input type="checkbox" id="global_ballcage_toggle" class="sr-only machine-toggle"
                        ...
                        <div class="flex items-center gap-2">
                            <button type="button" onclick="scrollTableHorizontal('left')"
                                class="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-slate-700 bg-slate-100 border border-slate-300 rounded-lg hover:bg-slate-200 transition-all">
                                <i data-lucide="arrow-left" class="w-3.5 h-3.5"></i>
                                Left
                            </button>
                            <button type="button" onclick="scrollTableHorizontal('right')"
                                class="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-slate-700 bg-slate-100 border border-slate-300 rounded-lg hover:bg-slate-200 transition-all">
                                Right
                    ...
                    <div id="tableScrollContainer" class="overflow-x-auto overflow-y-auto max-h-[65vh]">
                        <table class="w-full border-collapse" id="productionTable">
                            <thead style="background: linear-gradient(to right, #141d30, #2d3a52);">
                                <tr>
                                    <th class="border border-slate-300 px-3 py-2 text-center text-[10px] font-semibold text-white min-w-20 sticky top-0 z-20 whitespace-nowrap"
                                    ...
                                    <th class="border border-slate-300 px-3 py-2 text-center text-[10px] font-semibold text-white min-w-20 sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #172134;" title="Is Ballcage?">
                                        Ballcage
                                    </th>
                                    <th class="border border-slate-300 px-3 py-2 text-left text-[10px] font-semibold text-white min-w-44 sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #1a2538;">Machine</th>
                                    <th class="border border-slate-300 px-3 py-2 text-left text-[10px] font-semibold text-white min-w-64 sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #1e2d42;">Slide Size</th>
                                    <th class="border border-slate-300 px-3 py-2 text-center text-[10px] font-semibold text-white min-w-24 sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #22334a;">Total Set/Shift</th>
                                    <th class="border border-slate-300 px-3 py-2 text-center text-[10px] font-semibold text-white min-w-24 sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #263950;">Set/Hour</th>
                                    <!-- Hourly Columns -->
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="8-9">7AM-8AM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="9-10">8AM-9AM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="10-11">9AM-10AM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="11-12">10AM-11AM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="12-1">11AM-12PM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="1-2">12PM-1PM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="2-3">1PM-2PM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="3-4">2PM-3PM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="4-5">3PM-4PM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="5-6">4PM-5PM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="6-7">5PM-6PM</th>
                                    <th class="border border-slate-300 px-2 py-2 text-center text-[10px] font-semibold text-white min-w-20 hour-label sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;" data-hour="7-8">6PM-7PM</th>
                                    <th class="border border-slate-300 px-3 py-2 text-center text-[10px] font-semibold text-white min-w-20 sticky top-0 z-20 whitespace-nowrap"
                                        style="background: #2d3a52;">Actual Set</th>
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="{{ route('admin.production-reports.index') }}"
                class="px-4 py-2 text-sm font-medium text-slate-700 border border-slate-300 rounded-lg hover:bg-slate-50 transition-all">
                Cancel
            </a>
            <button type="button" id="saveDraftBtn" onclick="saveAsDraft()"
                class="px-5 py-2 text-sm font-medium text-amber-700 bg-amber-50 border border-amber-300 rounded-lg hover:bg-amber-100 transition-all">
                <i data-lucide="save" class="w-4 h-4 inline-block mr-1 -mt-0.5"></i>
                Save as Draft
            </button>
            <button type="submit" id="createSubmitBtn"
                class="px-6 py-2 text-sm font-medium text-white rounded-lg hover:shadow-lg transition-all"
                style="background: linear-gradient(to right, #141d30, #2d3a52);">
    ...
    <script>
        ...
        window.addEventListener('load', function () {
            // Auto-select shift based on current time (7 AM to 7 PM = Morning, else Night)
