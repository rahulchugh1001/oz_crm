        ...
        <div class="p-6 border-b border-slate-200">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    @else
                    <button type="button" class="inline-flex items-center gap-2 px-4 py-2 bg-slate-300 text-slate-500 font-semibold rounded-lg cursor-not-allowed opacity-70" title="No data available to export" disabled>
                        <i data-lucide="download" class="w-4 h-4"></i>
                        <span>Export to Excel</span>
                    </button>
                    @endif
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 mt-4">
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('admin.production-reports.sf001', ['mode' => 'ballcage']) }}" class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium border {{ $mode === 'ballcage' ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-slate-700 border-slate-300 hover:bg-slate-50' }}">
                        Ballcage
                    </a>
                ...
                <form action="{{ route('admin.production-reports.sf001') }}" method="GET" class="w-full lg:w-auto">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button type="submit" class="px-4 py-2 text-sm font-medium text-white rounded-lg transition-all" style="background: linear-gradient(to right, #141d30, #2d3a52);">
                            Search
                        </button>
                        @if(!empty($search))
            ...
            <table class="w-full text-[13px]">
                <thead class="border-b border-slate-200" style="background: linear-gradient(to right, #141d30, #2d3a52);">
                    <tr>
                        ...
                        <th class="px-3 py-2 text-left text-[10px] font-semibold text-white uppercase tracking-wider whitespace-nowrap">Machine</th>
                        <th class="px-3 py-2 text-left text-[10px] font-semibold text-white uppercase tracking-wider whitespace-nowrap">Slide Size</th>
                        ...
                        <th class="px-3 py-2 text-left text-[10px] font-semibold text-white uppercase tracking-wider whitespace-nowrap">Total Achieved Set</th>
                        ...
                        <th class="px-3 py-2 text-center text-[10px] font-semibold text-white uppercase tracking-wider whitespace-nowrap">Goal</th>
