        ...
        <div class="p-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-base font-semibold text-slate-900">Roll Forming (SF1) Process - Item Wise Stock</h2>
                        <p class="text-xs text-slate-500">View aggregated stock quantities by item from production reports</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-xs">
                <thead class="border-b border-slate-200" style="background: linear-gradient(to right, #141d30, #2d3a52);">
                    <tr>
                        <th class="px-3 py-2 text-left text-[10px] font-semibold text-white uppercase tracking-wider whitespace-nowrap">
                            #
                        </th>
                        <th class="px-3 py-2 text-left text-[10px] font-semibold text-white uppercase tracking-wider whitespace-nowrap">
                            Item Code
                        ...
                        <th class="px-3 py-2 text-center text-[10px] font-semibold text-white uppercase tracking-wider whitespace-nowrap">
                            Total Production
                        </th>
                        <th class="px-3 py-2 text-center text-[10px] font-semibold text-white uppercase tracking-wider whitespace-nowrap">
                            In Stock
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-3 py-2.5">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <a href="{{ route('admin.production-reports.sf001.stock.history', $item->id) }}" class="inline-flex items-center gap-1 px-2 py-0.5 text-[11px] font-medium text-slate-700 bg-slate-100 border border-slate-300 rounded-lg hover:bg-slate-200 transition-all">
        ...
        <div class="mt-3">
            ...
            <form id="transferForm" action="{{ route('admin.production-reports.sf001.stock.transfer') }}" method="POST" class="space-y-4">
                ...
                <div class="mt-6 flex items-center gap-3">
                    <button type="submit" id="transfer_submit_button" class="flex-1 px-4 py-2.5 text-white text-sm font-medium rounded-lg transition-colors" style="background: linear-gradient(to right, #141d30, #2d3a52);">
                        Save Transfer
                    </button>
