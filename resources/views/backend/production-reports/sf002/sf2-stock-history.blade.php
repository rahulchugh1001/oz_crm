...
<div class="p-4">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-subtle mb-4">
        ...
        <div class="border-t border-slate-200 flex">
            <button id="htab-btn-ced" onclick="switchHistoryTab('ced')"
                class="flex items-center gap-2 px-4 py-2.5 text-xs font-medium border-b-2 transition-colors htab-active">
            ...
            <button id="htab-btn-zinc" onclick="switchHistoryTab('zinc')"
                class="flex items-center gap-2 px-4 py-2.5 text-xs font-medium border-b-2 transition-colors htab-inactive">
    ...
    <div id="hpanel-ced">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-subtle overflow-hidden mb-4">
            <div class="p-4 border-b border-slate-200 flex items-center justify-between">
                <h3 class="text-sm font-semibold text-slate-900">CED Production Report History</h3>
                <div class="flex items-center gap-2">
                    <span class="text-xs text-slate-500">Total Records:</span>
                    <span class="text-xs font-semibold text-slate-900">{{ $cedHistory->count() }}</span>
                </div>
            </div>
                ...
                <table class="w-full text-xs">
                    ...
                    <tbody class="divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-slate-700">{{ $record->created_by_name ?? 'N/A' }}</td>
                            <td class="px-4 py-3 text-center">
                                <div class="inline-flex items-center gap-2 px-2.5 py-1 rounded-lg bg-slate-50 text-slate-700">
                                    <span class="font-semibold">{{ number_format($record->total_set_shift, 0) }}</span>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-center">
                        ...
                        <tr>
                            <td colspan="6" class="px-4 py-10 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-xs font-medium text-slate-900">No CED production history found</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-subtle overflow-hidden mb-4">
            <div class="p-4 border-b border-slate-200 flex items-center justify-between">
                <h3 class="text-sm font-semibold text-slate-900">CED Stock Transfer History</h3>
                <div class="flex items-center gap-2">
                    <span class="text-xs text-slate-500">Total Records:</span>
                    <span class="text-xs font-semibold text-slate-900">{{ $cedTransferHistory->count() }}</span>
                </div>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-xs">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-center">
                                @if($transfer->sf3_process === 'line_1')
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium bg-sky-50 text-sky-700">Assemble Line 1</span>
                                @elseif($transfer->sf3_process === 'line_2')
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium bg-violet-50 text-violet-700">Assemble Line 2</span>
                                @elseif($transfer->sf3_process === 'line_3')
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium bg-emerald-50 text-emerald-700">Assemble Line 3</span>
                                @elseif($transfer->sf3_process === 'line_4')
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium bg-amber-50 text-amber-700">Assemble Line 4</span>
                        ...
                        <tr>
                            <td colspan="11" class="px-4 py-10 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-xs font-medium text-slate-900">No CED transfer history found</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
    ...
    <div id="hpanel-zinc" class="hidden">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-subtle overflow-hidden mb-4">
            <div class="p-4 border-b border-slate-200 flex items-center justify-between">
                <h3 class="text-sm font-semibold text-slate-900">ZINC Production Report History</h3>
                <div class="flex items-center gap-2">
                    <span class="text-xs text-slate-500">Total Records:</span>
                    <span class="text-xs font-semibold text-slate-900">{{ $zincHistory->count() }}</span>
                </div>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-xs">
                        ...
                        <tr>
                            <td colspan="6" class="px-4 py-10 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-xs font-medium text-slate-900">No ZINC production history found</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-subtle overflow-hidden mb-4">
            <div class="p-4 border-b border-slate-200 flex items-center justify-between">
                <h3 class="text-sm font-semibold text-slate-900">ZINC Stock Transfer History</h3>
                <div class="flex items-center gap-2">
                    <span class="text-xs text-slate-500">Total Records:</span>
                    <span class="text-xs font-semibold text-slate-900">{{ $zincTransferHistory->count() }}</span>
                </div>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-xs">
                        ...
                        <tr>
                            <td colspan="11" class="px-4 py-10 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-xs font-medium text-slate-900">No ZINC transfer history found</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
