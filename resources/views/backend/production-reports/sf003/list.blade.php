...
@section('title', 'SF003 Process - Production Reports List')

@section('page-title', 'SF003 Process Management')

@section('breadcrumb')
    <span class="text-slate-600">Production Reports</span>
    <i data-lucide="chevron-right" class="w-4 h-4 mx-1 text-slate-400"></i>
    <span class="text-slate-600">SF003 Process</span>
    <i data-lucide="chevron-right" class="w-4 h-4 mx-1 text-slate-400"></i>
...
<div class="p-6">
    <div class="bg-white rounded-2xl border border-slate-200 shadow-subtle">
        <div class="p-12 flex flex-col items-center justify-center text-center">
            ...
            <h2 class="text-2xl font-bold text-slate-900 mb-2">SF003 Process - Coming Soon</h2>
            <p class="text-slate-500 mb-4">We're working hard to bring SF003 Production Reports feature to you.</p>
