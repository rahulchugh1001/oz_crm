...
return new class extends Migration
{
    ...
    {
        Schema::create('sf002_stock_transfers', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('item_id')->index();
            $table->string('type', 10)->comment('ced or zinc')->index();
            $table->unsignedBigInteger('transfer_by')->nullable()->index();
            $table->string('assign_role', 20)->nullable()->default('SF003')->index();
            ...
            $table->text('sf003_remark')->nullable();
    ...
    {
        Schema::dropIfExists('sf002_stock_transfers');
    }
};
